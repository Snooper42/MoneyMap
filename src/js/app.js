...
(function(){
  ...
  const oldSettings=window.renderSettings; if(typeof oldSettings==='function'){ window.renderSettings=function(){ oldSettings(); const el=document.getElementById('appBuildLabel'); if(el) el.textContent=(window.MoneyMapConfig&&window.MoneyMapConfig.buildId)||APP_BUILD_ID||'v0.1.1'; }; }
...
/* ---- R2.4 cache guard moved to src/js/core/cache-guard.js in v0.8. ---- */
