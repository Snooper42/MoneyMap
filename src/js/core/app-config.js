(function(){
  'use strict';
  const BUILD_ID='v0.1.5', STORAGE_KEY='moneymap_v1', ASSET_TOKEN='v0.1.5-20260530-1';
  window.MoneyMapConfig=Object.freeze({buildId:BUILD_ID,expectedBuild:BUILD_ID,storageKey:STORAGE_KEY,releaseName:'Desktop chart stability, lighter favicon, and leaner history flow',cacheBust:ASSET_TOKEN,localOnly:true});
