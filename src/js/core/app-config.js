(function(){
  'use strict';
  const BUILD_ID='v0.1.4', STORAGE_KEY='moneymap_v1', ASSET_TOKEN='v0.1.4-20260530-2';
  window.MoneyMapConfig=Object.freeze({buildId:BUILD_ID,expectedBuild:BUILD_ID,storageKey:STORAGE_KEY,releaseName:'Desktop accounts reliability, local chart popovers, and cache hardening',cacheBust:ASSET_TOKEN,localOnly:true});
